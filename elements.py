...
class Adder:  # сумматор
    ...
    def display_struct(self, x, y, c, wc):  # рисование сумматора на структурктурной схеме
        ...
        c.create_polygon(x + ((wc / 2) - 50), y + 20, x + 40 + ((wc / 2) - 50), y + 20, x + 50 + ((wc / 2) - 50),
                         y + 30, x + 60 + ((wc / 2) - 50), y + 20, x + 100 + ((wc / 2) - 50), y + 20,
                         x + 80 + ((wc / 2) - 50), y + 43, x + 20 + ((wc / 2) - 50), y + 43, outline='black',
                         fill='white')
        # print (x)
